...
namespace xadrez
{
    ...
    class Dama : Peca
    {
        ...
        // Método para retornar os movimentos possiveis de uma peça do tipo 'Dama' em uma matriz de booleanos
        public override bool[,] movimentosPossiveis()
        {
            ...
            while (tab.posicaoValida(pos) && podeMover(pos))
            {
                ...
                // Aumenta uma casa de distância enquanto a posição for valida
